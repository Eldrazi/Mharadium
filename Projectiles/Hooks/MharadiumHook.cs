...
namespace Mharadium.Projectiles.Hooks
{
    public class MharadiumHook : ModProjectile
    {
        public static MharadiumHook mharadiumHook = new MharadiumHook();
        ...
        public override void PostDraw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2 = ModLoader.GetTexture("Mharadium/Projectiles/Hooks/MharadiumHook_Chain");
